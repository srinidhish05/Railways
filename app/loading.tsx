...
export default function Loading() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#bae6fd] via-[#38bdf8] to-[#6366f1] relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-8 py-12 glass-card dashboard-shadow animate-fade-in">
        ...
        {/* Loading Text */}
        <h2 className="text-3xl font-extrabold text-blue-700 mb-3 animate-pulse drop-shadow-lg">Karnataka Railway Network</h2>
        <p className="text-blue-600 mb-8 text-lg">Connecting Karnataka with reliable rail services...</p>
        {/* Status Indicator */}
        <div className="flex justify-center items-center space-x-3 mb-6">
          <Loader2 className="h-5 w-5 animate-spin text-blue-600" />
          <span className="text-blue-700 font-semibold">Initializing railway network...</span>
        </div>
        {/* Loading Dots */}
        ...
        {/* Railway Services */}
        <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto text-sm text-blue-700">
        ...
        <div className="mt-8 max-w-xs mx-auto">
          ...
          <p className="text-xs text-blue-700 mt-2">Loading railway services...</p>
        </div>
      </div>
      <style>{`
        @keyframes fade-in {
